...
public class TeamFileHandler {
     ...
     *  @return Team object.
     */
    public Team readTeam(String transmittedFile) {

        // Create an instance of file.
        File fileHandler = new File(transmittedFile);

        // Check if file is opened.
        if (!checkFileExists(fileHandler)) return null;

        /** Reads the file and returns
         *  an instance of a team class.
         */
        Team teamObject = readFile(fileHandler);
